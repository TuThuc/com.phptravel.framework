package com.phptravel.ultilities.excelultils;
...
public class ExcelUtil {
    ...
    public static final String       currentDir            = GlobalConstants.getGlobalConstants().getProjectPath();  //Main Directory of the project

    public static final String       osName            = GlobalConstants.getGlobalConstants().getOsName();  //OS name
